...
class SLACK_TOKENS(enum.Enum):
  ...
  App_Level_Token = (enum.auto(), "/sns/slack/aws-slack-tutorial/App_Level_Token")
  SLACK_SIGNING_SECRET = (enum.auto(), "/sns/slack/aws-slack-tutorial/SLACK_SIGNING_SECRET")

class SLACK_CHANNELS(enum.Enum):
  ALARM = (enum.auto(), "C08RHBS4DGC", "알람")
  ERROR = (enum.auto(), "C08RRMXQCAD", "에러")
  AWS_PRIVATE = (enum.auto(), "C08RBDZ1P2R", "AWS 프라이빗")
  AWS_PUBLIC = (enum.auto(), "C08R718JNMC", "AWS 퍼블릭")
